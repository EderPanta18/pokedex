...
function ListPokemon() {
    ...
    return (
        <div>
            {loading ? (<Loader />) : (
                <div className='h-[calc(100vh-150px)] overflow-y-auto xl:mx-32 mx-3 mt-3 pr-3'>
                    {filteredPokemonsByType.length ? (
                        <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 ml-3'>
