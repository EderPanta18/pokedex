...
function HomePage() {
    const { active, setActive, loading } = useContext(PokemonContext)
    return (
        <div className='font-mono mt-16 flex flex-col items-end sm:items-center'>
            <div className={`mt-3 text-white mr-10 sm:mr-0 ${loading ? 'hidden' : ''}`}>
                <button onClick={() => setActive(!active)} className='flex gap-1'>
